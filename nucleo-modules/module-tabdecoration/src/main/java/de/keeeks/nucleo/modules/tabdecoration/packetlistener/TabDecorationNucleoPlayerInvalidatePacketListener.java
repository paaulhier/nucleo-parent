...
public final class TabDecorationNucleoPlayerInvalidatePacketListener extends PacketListener<NucleoPlayerInvalidatePacket> {
    private final TabDecorationService tabDecorationService = ServiceRegistry.service(TabDecorationService.class);

    public TabDecorationNucleoPlayerInvalidatePacketListener() {
